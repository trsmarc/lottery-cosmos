...
exports.Params = {
    ...
    toJSON: function (message) {
        ...
        if (message.sendEnabled) {
            obj.sendEnabled = message.sendEnabled.map(function (e) { return e ? exports.SendEnabled.toJSON(e) : undefined; });
        }
        else {
            obj.sendEnabled = [];
        }
...
exports.Metadata = {
    ...
    fromJSON: function (object) {
        return {
            ...
            denomUnits: Array.isArray(object === null || object === void 0 ? void 0 : object.denomUnits) ? object.denomUnits.map(function (e) { return exports.DenomUnit.fromJSON(e); }) : [],
    ...
    toJSON: function (message) {
        ...
        if (message.denomUnits) {
            obj.denomUnits = message.denomUnits.map(function (e) { return e ? exports.DenomUnit.toJSON(e) : undefined; });
        }
        else {
            obj.denomUnits = [];
        }
