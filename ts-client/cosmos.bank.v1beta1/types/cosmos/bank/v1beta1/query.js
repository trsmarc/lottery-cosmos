...
exports.QueryDenomOwnersResponse = {
    ...
    fromJSON: function (object) {
        return {
            denomOwners: Array.isArray(object === null || object === void 0 ? void 0 : object.denomOwners) ? object.denomOwners.map(function (e) { return exports.DenomOwner.fromJSON(e); }) : [],
            pagination: isSet(object.pagination) ? pagination_1.PageResponse.fromJSON(object.pagination) : undefined
        };
    },
    toJSON: function (message) {
        ...
        if (message.denomOwners) {
            obj.denomOwners = message.denomOwners.map(function (e) { return e ? exports.DenomOwner.toJSON(e) : undefined; });
        }
        else {
            obj.denomOwners = [];
        }
