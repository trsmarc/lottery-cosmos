...
var Api = /** @class */ (function (_super) {
    ...
    function Api() {
       ...
       */
        _this.serviceABCIQuery = function (query, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/cosmos/base/tendermint/v1beta1/abci_query", method: "GET", query: query, format: "json" }, params));
        };
        /**
         * No description
         *
         ...
         */
        _this.serviceGetLatestBlock = function (params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/cosmos/base/tendermint/v1beta1/blocks/latest", method: "GET", format: "json" }, params));
        };
        /**
         * No description
         *
         ...
         */
        _this.serviceGetBlockByHeight = function (height, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/cosmos/base/tendermint/v1beta1/blocks/".concat(height), method: "GET", format: "json" }, params));
        };
        /**
         * No description
         *
         ...
         */
        _this.serviceGetNodeInfo = function (params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/cosmos/base/tendermint/v1beta1/node_info", method: "GET", format: "json" }, params));
        };
        /**
         * No description
         *
         ...
         */
        _this.serviceGetSyncing = function (params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/cosmos/base/tendermint/v1beta1/syncing", method: "GET", format: "json" }, params));
        };
        /**
         * No description
         *
         ...
         */
        _this.serviceGetLatestValidatorSet = function (query, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/cosmos/base/tendermint/v1beta1/validatorsets/latest", method: "GET", query: query, format: "json" }, params));
        };
        /**
         * No description
         *
         ...
         */
        _this.serviceGetValidatorSetByHeight = function (height, query, params) {
            if (params === void 0) { params = {}; }
            return _this.request(__assign({ path: "/cosmos/base/tendermint/v1beta1/validatorsets/".concat(height), method: "GET", query: query, format: "json" }, params));
        };
        return _this;
    }
    return Api;
